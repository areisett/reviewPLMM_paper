...
\anna{(1) fixed vs. random, (2) decomposition}
...
\anna{qualitative explanation, then quantitative}
...
\anna{talk about a low-rank approximation of xtx-inv for a unique solution}
