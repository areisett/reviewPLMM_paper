...
\pb{What is the significance of this Mandt paper? Isn't there a huge literature on GLMMs?}\anna{Mandt is specifically for high-dimensional, penalized LMMs that use the data to infer structure of the errors - not just a regular GLMM. Includes some of the Rakitsch 2013 authors, extends LMM-lasso to binary outcomes in one way.}
