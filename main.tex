...
\pb{these are nice figures, but to me, better for supplement}
...
\begin{figure}[H]
    ...
    \caption{Relative performance of LMM-Lasso, PC-Lasso in terms of estimation accuracy:  \anna{$\bgamma$ structure is nonlinear (aka half and half) and heterogeneous, $\eta= \xi = 0.5$}}
...
\anna{replace this with inedpendent subpopulations}
\begin{figure}[H]
    \centering
    % \includegraphics[scale = 0.9]{figures/fig2b.png}
    \includegraphics[scale = 0.9]{figures/mse_diff_hetero.png}
    \caption{Relative performance of LMM-Lasso, PC-Lasso for different subpopulation and $\bgamma$ structures: \anna{structureX is 1d linear admixture, $\eta= \xi = 0.5$}}
...
\begin{figure}[H]
    ...
    \includegraphics[scale = 1]{figures/eta_beta_hat.png}
     \caption{Caption goes here \anna{$\xi = 0.5$, structureX = 1d linear, structureGamma is half and half heterogeneous}}
...
\begin{figure}[H]
    ...
    \caption{Caption goes here \anna{$\eta = \xi = 0.5$, structureX = 1d linear, structureGamma is half and half heterogeneous}}
    \label{fig:time}
\end{figure}
