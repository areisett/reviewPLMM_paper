...
\anna{We show this in the absence of fixed covariates for the sake of a clear illustration.. $\bX_0 \bbeta_0$ unpenalized things}
...
\anna{In the presence of unpenalized covariates to adjust for like age and sex... equations 7 and 8 and X-tilde become this... penalty term only penalizes beta1 - betas corresponding to SNPs}
