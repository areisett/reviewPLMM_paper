...
\anna{Using the metric $||\bX \boldsymbol{\tau}||_2 / ||\bZ \bgamma||_2$}

\anna{quantify this for all 3 data settings using $||\bX \boldsymbol{\tau}||_2 / ||\bZ \bgamma||_2$: Admixture ratio = 0.46412, Independent ratio = 0.98615, Vanderwas ratio = 0.64325} 

This improvement is more substantial in the semi-empirical and independent subpopulations data than the admixed data. This is due to the fact that the discrete, nonoverlapping genetic subpopulations more directly correspond to the distinct fixed environmental effects than do the more continuous and blended subpopulations in the admixture data. In other words, a greater proportion of the environmental effect is in the column space of the projection matrix of $\bX$ for the semi-empirical and independent subpopulations data than in the admixed data. 

As such, there is a greater amount of confounding and potential estimation bias in the independent subpopulations which can be corrected by the PC-Lasso and LMM-Lasso methods. 
