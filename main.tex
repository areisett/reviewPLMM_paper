...
$$\text{Precision }= 1 - \frac{\#\{ \beta = 0 \cap \widehat{\beta} \ne 0  \}}{\#\{ \widehat{\beta} \ne 0 \}} = \frac{\#\{ \beta \ne 0 \cap \widehat{\beta} \ne 0  \}}{\#\{ \widehat{\beta} \ne 0 \}}$$

\begin{figure}[H]
\centering
\includegraphics[scale = 0.9]{figures/genomewide_prc2.png}
\caption{Precision values for each method and number of selected SNPs from the Empirical genome-wide analysis. Single replication case study with $\eta = 0.5, \xi = 0.8$.}
\label{fig:gw_prc2}
\end{figure}
...
\anna{Why is pc-lasso doing so terribly? \textbf{original bad seed + depends on how you're defining precision... selects a lot of true snps but often they have the wrong sign}}\\

\begin{figure}[H]
\centering
\includegraphics[scale = 0.9]{figures/genomewide_mse.png}
