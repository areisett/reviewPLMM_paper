...
\begin{figure}[H]
    ...
    \caption{Estimation accuracy of different methods for different data types in the presence and absence of environmental confounding with 4 subpopulations. Mean and 1 SE bars displayed for 1000 replications.}
    \label{fig:mse}
\end{figure}
