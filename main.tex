...
\subsection{Software}
\label{sec:software}
\anna{More discussion of software. Add a small section? R-based Software for lasso, pc-lasso, ggmix, plmm, PLINK functions, KING, snpRelate}
...
\anna{penalty parameter selection; also a tough one. We need to say more, but not a great deal is known.}
