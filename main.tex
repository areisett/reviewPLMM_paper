...
\pb{I'm confused -- this formula does NOT require sign to be correct.  What's right, the formula or the text?}
...
\caption{\pb{I feel like we should stop this at 200.  The 100-400 range dominates this plot and what I get from this figure is: all the methods are equally bad.} Precision for each method and number of selected SNPs from the Empirical genome-wide analysis. Single replication case study with $\eta = 0.5, \xi = 0.8$.}
\label{fig:gw_prc}
\end{figure}
...
%------------------------------%
\subsection{PC-lasso and LMM-lasso increase genome-wide estimation accuracy}
%------------------------------%
...
\pb{I did change this paragraph a bit; I feel that we need to acknowledge and be honest about the fact that PC-lasso outperformed LMM-lasso here.}
