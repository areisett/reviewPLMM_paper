...
\anna{Obviously these need to be formatted... just use TP rates - FP not adding much}\\
...
\anna{add some info/figure on convergence and number of iterations for lmm-lasso vs ggmix, delete the following time figures and references to them}
...
\end{figure}
\anna{replace this figure with one that includes time in the third row}
