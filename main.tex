...
\anna{
admixture simulated data sets do worse in the large subpops setting because their similarity matrix does not indicate as clearly who was exposed to one of e.g. 4 environmental exposures; it is a better proxy for environmental effects.\\
}

\anna{
the small subpopulations scenario more closely mimics a gradient of environmental effects - what is usually simulated with a random draw from the MVN distn... \\
}

\anna{
we're simulating environmental heterogeneity in a way that allows us to examine the bias produced and these methods still do as well or better than pca}\\
