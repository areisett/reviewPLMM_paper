...
\anna{LMM-lasso seems to exhibit even stronger control of this than PC-lasso.}

%In both scenarios, LMM-lasso is more robust to allele frequency differences than PC-lasso due to the presence of \anna{finer grained relatedness in addition to population stratification in the Empirical data.} This echoes the superior TPRs of LMM-lasso compared to that of the PC-lasso in the case of the Empirical data in Table \ref{tab:var_sel}.
